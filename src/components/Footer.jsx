...
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer className="footer p-10 bg-[#A55E3F] text-white rounded-t-3xl">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-white text-[#A55E3F] border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Crafty Canvas Ltd. <br/>Providing reliable art since 1992</p>
  </aside> 
...
<div className='text-[#A55E3F] text-center'>
        <aside>
    <p>Copyright © 2024 - All right reserved by Crafty Canvas Ltd</p>
  </aside>
        </div>
        </div>
    );
